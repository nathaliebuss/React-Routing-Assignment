    ...
    <>
      <header className={style.headerContainer}>
        ...
        <div className={style.navbar}>
          <nav
            className={`${style.navContainer} ${showBurgerMenu ? style.navOpen : ""}`}
          >
            <NavLink
              className={({ isActive }) =>
                isActive ? style.active : style.navItem
              }
              to="/"
              onClick={closeAll}
            >
            ...
            <div className={`${style.dropMenu} ${style.dropMenuTrigger}`}>
              <p className={style.navItem} onClick={dropMenuClick}>
                Characters
              </p>
              {showDropMenu && (
